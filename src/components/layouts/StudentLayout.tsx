...
const StudentLayout = ({ children, title }: StudentLayoutProps) => {
    ...
    return (
      <Link 
        ...
        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
          isActive ? "bg-kids-light-blue text-kids-blue font-medium" : "hover:bg-gray-100"
        }`}
  ...
  return (
    <div className="min-h-screen bg-kids-light-blue bg-opacity-20">
      {/* Header */}
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img 
              ...
              className="h-10 w-10"
            />
            <h1 className="text-xl md:text-2xl font-bold text-kids-blue">Peduli Kesehatan Anak SD</h1>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-4">
            <NavLink to="/siswa" icon={Home} label="Dashboard" />
            <NavLink to="/siswa/isi-data" icon={FileText} label="Isi Data Kesehatan" />
            <NavLink to="/siswa/keluhan" icon={User} label="Keluhan" />
        ...
        <div className="mb-8">
          ...
          {user && (
            <p className="text-center text-gray-600">
              Selamat datang, {user.name} | Kelas {user.kelas}
            </p>
          )}
        </div>
        {children}
      ...
      {/* Footer */}
      <footer className="bg-kids-blue text-white py-4">
